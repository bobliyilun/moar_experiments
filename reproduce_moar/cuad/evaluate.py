...
def evaluate_results(dataset_file_path: str, results_file_path: str) -> Dict[str, Any]:
    ground_truth_file = "/Users/yilunli/Desktop/moar_experiments/moar_experiments/data/CUAD-master_clauses.csv"
    return evaluate_results_main("gemini_gemini_opt", results_file_path, ground_truth_file, dataset_file_path)